...
public class Action {
    ...
    public static void sum() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Сложение", number1, number2, summ});
    ...
    public static void minus() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Вычитание", number1, number2, minuss});
    ...
    public static void multi() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Умножение", number1, number2, multii});
    ...
    public static void div() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Деление чисел", number1, number2, divv});
    ...
    public static void del() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Деление по модулю", number1, number2, dell});
    ...
    public static void modul() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Модуль", number1, 0d, modull});
    ...
    public static void stepen() throws SQLException {
        ...
        InsertIntoTable.insertIntoTable(new Object[] {"Возведение в степень", number1, number2, stepenn});
